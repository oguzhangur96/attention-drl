...
from Network import Qnet_DCBAMRQN
...
save_interval = 10000
model_path = './Models/Mario_DCBAMRQN.model'
history_path = './Train_Historys/Mario_DCBAMRQN'
eval_history_path = './Train_Historys/eval_Mario_DCBAMRQN'
...
def main():
    ...
    targetNet = Qnet_DCBAMRQN(gate_channels=64).to(device)
