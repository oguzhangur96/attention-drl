...
parser.add_argument('--buffer_path', default='./Models/Breakout_DARQN.buffer', type=str)
parser.add_argument('--history_path', default='./Train_Historys/Breakout_DARQN', type=str)
parser.add_argument('--eval_history_path', default='./Train_Historys/eval_Breakout_DARQN', type=str)
...
def main(args):
    ...
    while step < args.train_max_step:
        ...
        if step > 0 and step % args.save_interval == 0:
            ...
            np.save(args.eval_history_path, np.array(eval_history))
